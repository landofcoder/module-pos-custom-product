...
class AddPosCashierEmailAttribute implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public function apply()
    {
        ...
        $eavSetup->addAttribute(
          ...
          $attribute = $eavSetup->getAttribute(\Magento\Catalog\Model\Product::ENTITY, 'pos_cashier_email');
    ...
    public function revert()
    {
        ...
        $eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'pos_cashier_email');
